				...
				<div className="flex flex-col gap-8">
					...
					<div className="w-full flex flex-row gap-8">
						<form
										...
										<Image
											...
											src={
												preview
													...
													: `${process.env.NEXT_PUBLIC_IMAGES}/images/users/${user.image}`
											}
											alt={user.name}
											width={64}
											height={96}
							...
							<article>
								<button
									className="bg-blue-800 hover-bg-blue-500 transition-all ease-in duration-200 w-56 rounded mt-6 p-3 drop-shadow-sm"
									type="submit">
