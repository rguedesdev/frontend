					...
					<div className="col-start-2 col-span-8 flex flex-col">
						<div className="flex flex-row mt-4">
							<Image
								...
								src={`${process.env.NEXT_PUBLIC_API}/images/mangakas/${mangaka.image}`}
						...
						<Link
							target="_BLANK"
							className="bg-blue-500 hover:bg-blue-600 transition-all ease-in duration-200 text-white p-2 rounded px-14 w-64 mb-4 flex flex-row justify-center items-center gap-4 shadow-md"
